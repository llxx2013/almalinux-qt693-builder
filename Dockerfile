...
RUN dnf install -y --nodocs tree file cmake ninja-build git wget meson \
    ...
    sqlite-devel libzstd-devel libicu-devel glib2-devel xcb-util-wm-devel libXrender-devel xcb-util-cursor-devel \
	systemd-devel libb2-devel libproxy-devel at-spi2-core-devel gtk3-devel libinput-devel \
